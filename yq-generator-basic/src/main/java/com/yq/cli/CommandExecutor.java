...
import com.yq.cli.command.ConfigCommand;
import com.yq.cli.command.GeneratorCommand;
import com.yq.cli.command.ListCommand;
 ...
 */
@Command(name = "yq",mixinStandardHelpOptions = true)
