...
/** downloadFileTest GET /api/file/test/download */
export async function downloadFileTestUsingGet(
  // 叠加生成的Param类型 (非body参数swagger默认没有生成对象)
  params: API.downloadFileTestUsingGETParams,
...
/** uploadFileTest POST /api/file/test/upload */
export async function uploadFileTestUsingPost(
  body: {},
  file?: File,
  options?: { [key: string]: any },
) {
